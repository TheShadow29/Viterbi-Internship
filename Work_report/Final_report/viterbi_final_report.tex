...
% \subsection{Invariance Check}
% Simple experiments were run to check how invariant the features detected by CNN actually are.
% \subsubsection{Scale Invariance}
% In this experiment, we simply took one image as fixed and then rescaled this image by different scale factors.
% \subsubsection{Contrast Invariance}
